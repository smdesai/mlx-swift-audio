...
//  Main Chatterbox TTS model orchestrator
//
...
public let ChatterboxS3Sr = 16000

/// Sample rate for vocoder output (24kHz)
public let ChatterboxS3GenSr = 24000

/// Size of speech token vocabulary (3^8 = 6561)
public let ChatterboxSpeechVocabSize = 6561

// MARK: - Special Tokens

public let ChatterboxSOT = "[START]"
public let ChatterboxEOT = "[STOP]"
public let ChatterboxSPACE = "[SPACE]"
...
public func dropInvalidTokens(_ x: MLXArray) -> MLXArray {
...
public struct ChatterboxConditionals: @unchecked Sendable {
  /// T3 conditioning (speaker embedding, prompt tokens, emotion)
  public var t3: T3Cond

  /// S3Gen reference dictionary
  public var gen: S3GenRefDict

  public init(t3: T3Cond, gen: S3GenRefDict) {
    self.t3 = t3
    self.gen = gen
  }
}

// MARK: - ChatterboxTTS Model
...
public class ChatterboxTTS: Module {
  /// Default Hugging Face repository for Chatterbox TTS (4-bit quantized)
  public static let defaultRepoId = "mlx-community/Chatterbox-TTS-4bit"

  /// Encoder conditioning length (6 seconds at 16kHz)
  public static let encCondLen = 6 * ChatterboxS3Sr

  /// Decoder conditioning length (10 seconds at 24kHz)
  public static let decCondLen = 10 * ChatterboxS3GenSr

  /// Output sample rate
  public let sr: Int = ChatterboxS3GenSr

  /// Configuration
  public let config: ChatterboxModelConfig
  ...
  public var textTokenizer: EnTokenizer?

  /// Pre-computed conditionals (optional)
  public var conds: ChatterboxConditionals?

  public init(config: ChatterboxModelConfig? = nil) {
  ...
  public func loadTextTokenizer(vocabFilePath: String) throws {
  ...
  /// - Returns: Initialized ChatterboxTTS model with loaded weights
